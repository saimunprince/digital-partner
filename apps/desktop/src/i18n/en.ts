...
export const en: Translations = {
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your {brand} backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting {brand}.',
  ...
  keybinds: {
    ...
    actions: {
      ...
      'nav.memory': 'Open memory',
      'nav.activity': 'Open activity',
      'nav.integrations': 'Open integrations',
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the {brand} backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the {brand} backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      kinds: {
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while {brand} was in the background.'
        }
      },
    ...
    appearance: {
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and {brand} can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what {brand} is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen {brand}, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        '{brand} checks for updates automatically in the background and lets you know when one is ready.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening {brand}.',
    ...
    connections: {
      ...
      kindSsh: 'SSH',
      kindLocalDesc: 'The {brand} runtime managed by this app.',
      kindRemoteDesc: 'A {brand} gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Hermes Cloud account.',
      kindSshDesc: 'A {brand} install reached over SSH.',
      labelTitle: 'Name',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a {brand} backend elsewhere. Per-profile overrides below.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote {brand} backend.',
      ...
      restartingMessage: '{brand} will reconnect using the saved settings — the shell stays open.',
      ...
      sshDesc:
        '{brand} is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — {brand} found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — {brand} runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrPlatform:
        'Unsupported remote platform. {brand} SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update {brand} on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. {brand} runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point {brand} at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: '{brand} did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. {brand} will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the {brand} backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
  ...
  updates: {
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the {brand} desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The {brand} updater takes over in its own window and reopens {brand} automatically when it’s done. Please don’t reopen {brand} yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. {brand} reconnects automatically when it’s back.',
  ...
  install: {
    ...
    setupChoiceTitle: 'Set up {brand}',
    setupChoiceDesc:
      'Connect this app to a {brand} gateway you already run, or install {brand} locally on this computer.',
    connectExistingTitle: 'Connect to existing {brand}',
    ...
    installLocalTitle: 'Install {brand} locally',
    installLocalDesc: 'Download {brand}, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart {brand} and try again.',
    remoteSetupTitle: 'Connect to existing {brand}',
    remoteSetupDesc: 'Enter your gateway URL. {brand} will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the {brand} gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that {brand} gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up {brand} Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another {brand} CLI or desktop instance is running. Stop any running {brand} instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The {brand} installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with {brand} Agent",
  ...
  preview: {
    ...
    web: {
      ...
      stillWorking:
        '{brand} is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
