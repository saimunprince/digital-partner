...
export const ar = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'جار تحميل إعدادات {brand}',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingHermesDesktop: 'جار تشغيل {brand}...'
    },
    errors: {
      backgroundExited: 'خرجت عملية {brand} الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية {brand} الخلفية أثناء بدء التشغيل.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية {brand} أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateHermes: 'تحديث {brand}',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل {brand}.',
    ...
    native: {
      ...
      inputBody: 'ينتظر {brand} ردّك.',
      turnDoneTitle: 'أنهى {brand}',
      turnDoneBody: '',
  ...
  keybinds: {
    ...
    actions: {
      ...
      'nav.home': 'فتح الرئيسية',
      'nav.tasks': 'فتح المهام',
      'nav.calendar': 'فتح التقويم',
      'nav.memory': 'فتح الذاكرة',
      'nav.activity': 'فتح النشاط',
      'nav.integrations': 'فتح التكاملات',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات {brand}؟',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها {brand}). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون {brand} في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح {brand} سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان {brand} في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    appearance: {
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح {brand}.',
      reactionsTitle: 'تفاعلات الرسائل',
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ {brand} التفاعل مع رسائلك.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله {brand} — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق {brand} وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج {brand} إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف {brand} التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع {brand} قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل {brand} مع الأوامر التي تحتاج موافقة صريحة.',
    ...
    about: {
      ...
      automaticUpdatesDesc: 'اسمح لـ {brand} بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      loading: 'جار تحميل إعدادات {brand}...',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح {brand}.',
    ...
    gateway: {
      ...
      intro:
        'يشغّل {brand} بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية {brand} تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق.',
      appliesTo: 'ينطبق على',
      ...
      localDesc: 'تشغيل خلفية {brand} خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      ...
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية {brand} بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      ...
      restartingMessage: 'سيعيد {brand} الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · {brand} ${version}` : ''}`,
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل {brand} تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل {brand} لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث {brand} لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك {brand} عند الانتهاء.',
    ...
    hermesActiveSessions: (version, count) => `{brand} ${version} لديه ${count} جلسة نشطة`,
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'لم يحفظ {brand} تغيير النموذج هذا.'
    },
    search: 'بحث',
    loading: 'جار التحميل...',
    states: {
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل {brand} تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها {brand} تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من {brand} أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من {brand}. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء {brand}...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل {brand} عن شيء...', 'اطلب من {brand} تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ {brand} الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من {brand} فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث {brand}...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل {brand}...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من {brand} تحديث نفسه من داخل التطبيق.',
    ...
    availableBody: 'إصدار جديد من {brand} جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة {brand} الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت {brand} من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط {brand} الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق {brand} لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
      'يتولّى مُحدِّث {brand} المهمة في نافذته الخاصة ويعيد فتح {brand} تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح {brand} بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد {brand} الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد {brand} فتح نفسه تلقائيا.',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج {brand} إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل {brand}',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من {brand} CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ {brand} قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت {brand} بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك {brand} Agent',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل {brand} التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء {brand}...',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل {brand}',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه {brand} إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل {brand} تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل {brand} تلقائياً',
    ...
    authorizeThere: 'صرّح لـ {brand} هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ {brand} هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض {brand} أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل {brand}...',
      askRestart: 'اطلب من {brand} إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث {brand} عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل {brand} في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      finishedRestarting: message => `أنهى {brand} إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على {brand} إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال {brand} يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
