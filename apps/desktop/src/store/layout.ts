...
// true. Owned here beside the other shell layout prefs. Window-scoped like
// the other layout prefs, not connection-scoped: which rail you collapsed is
// about this window, not about which gateway it is talking to.
