  ...
  return (
    <div className={`h-full overflow-y-auto ${PAGE_INSET_X}`}>
      <div className={`mx-auto w-full ${PAGE_MAX_W} py-8`}>
        <h1 className="text-sm font-semibold">{t.partner.calendar.title}</h1>
        <EmptyState className="min-h-[60vh]" description={t.partner.calendar.emptyDesc} title={t.partner.calendar.emptyTitle} />
      </div>
    </div>
  )
}
