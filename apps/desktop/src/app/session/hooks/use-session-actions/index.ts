...
//
// Exported because the voice command centre creates its own background session
// (see use-quick-entry-bridge) and must mint the same params a normal new chat
// does — profile handshake, model, cwd — rather than a bespoke set that
